 ...
 * @date 2020/12/8
 */
public class WzfKafkaConsumer extends Thread{

    KafkaConsumer kafkaConsumer;
    String topic;

    public WzfKafkaConsumer(String topic) {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG,"wzf-group02");
    ...
    public static void main(String[] args) {
        new WzfKafkaConsumer("second-test").start();
    }
}
